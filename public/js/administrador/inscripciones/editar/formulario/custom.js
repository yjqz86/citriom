$(document).ready(function(){/*
  //Variables
  var pago1 = {'banco': $("#banco1").val(), 'tipoPago': $("#tipoPago1").val(), 'referencia': $("#referenciaPago1").val(), 'fecha': $("#fechaPago1").val(), 'monto': parseFloat($("#montoPago1").val())};
  if($("#banco2").val() != ''){
    var pago2 = {'banco': $("#banco2").val(), 'tipoPago': $("#tipoPago2").val(), 'referencia': $("#referenciaPago2").val(), 'fecha': $("#fechaPago2").val(), 'monto': parseFloat($("#montoPago2").val())};;
  }else{
    var pago2;
  }
  if($("#banco3").val() != ''){
    var pago3 = {'banco': $("#banco3").val(), 'tipoPago': $("#tipoPago3").val(), 'referencia': $("#referenciaPago3").val(), 'fecha': $("#fechaPago3").val(), 'monto': parseFloat($("#montoPago3").val())};;
  }else{
    var pago3;
  }
  var total = parseFloat($("#cancelado").text());
  var cancelado;
  var restante;*/
