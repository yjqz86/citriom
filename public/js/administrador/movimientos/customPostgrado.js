$(document).ready(function(){
  ...
  $("#cedula").change(function(){
    ...
    $.ajax({
      ...
      url:   'movimientos/obtener-estudiante-postgrado',
      type:  'post',
  ...
  $("#guardar").click(function(){
    ...
    $.ajax({
      ...
      url:   'movimientos/obtener-notas-postgrado',
      type:  'post',
      success:  function (data) {
  ...
  $("#aceptar").click(function(){
    ...
    $.ajax({
      ...
      url:   'movimientos/acta-enmienda-postgrado',
      type:  'post',
      success:  function (data) {
        window.location = 'movimientos-postgrado';
      }
    });
  });
});
