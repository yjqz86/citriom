$(document).ready(function(){
  ...
  //Operaciones al escribir un nivel
  ...
  $("#turno").change(function(){
  	if ($("#niveles").val().indexOf('I') != -1) {

  		if ($("#turno").val() == 'Semi-Presencial') {
  		  	$('#aulas').html('<option></option><option value="VIRTUAL">VIRTUAL</option>');
	      	//Pone los dias virtuales
	      	$('#dias').html('<option></option><option value="VIRTUAL">VIRTUAL</option>');
	      	//Desactiva las horas y pone de texto 'VIRTUAL'
	        ...
	        type:  'post',
	        success:  function (data) {	
	          $('#aulas').html('<option></option><option value="Seleccione">Seleccione</option>');	
	          $('#dias').html('<option></option><option value="Seleccione">Seleccione</option>');	
	          $('#dias').html(data.dias);
	          $('#aulas').html(data.aulas);
	        }
			});
